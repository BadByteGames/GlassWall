...
void GW::Component::setOrientation(glm::vec3 angles)
{
	m_orientation = glm::vec3((angles.x * PI) / 180.0f, (angles.y * PI) / 180.0f, (angles.z * PI) / 180.0f);
}
...
glm::mat4 GW::Component::getTransform()
{
	if (m_absoluteMode) {
		...
		transformation = glm::rotate(transformation, m_orientation.x, glm::vec3(1.0f, 0.0f, 0.0f));
		transformation = glm::rotate(transformation, m_orientation.y, glm::vec3(0.0f, 1.0f, 0.0f));
		transformation = glm::rotate(transformation, m_orientation.z, glm::vec3(0.0f, 0.0f, 1.0f));
...
glm::vec3 GW::Component::getAbsolutePosition()
{
	if (m_absoluteMode) {
		...
		glm::vec4 absoluteTranslation = glm::rotate(glm::mat4(1.0f), (m_orientation.x * PI) / 180.0f, glm::vec3(1.0f, 0.0f, 0.0f)) * glm::vec4(m_relativePosition, 1.0f);
		absoluteTranslation = glm::rotate(glm::mat4(1.0f), (m_orientation.y * PI) / 180.0f, glm::vec3(0.0f, 1.0f, 0.0f)) * absoluteTranslation;
		absoluteTranslation = glm::rotate(glm::mat4(1.0f), (m_orientation.z * PI) / 180.0f, glm::vec3(0.0f, 0.0f, 1.0f)) * absoluteTranslation;
		if (m_parent != nullptr) {
